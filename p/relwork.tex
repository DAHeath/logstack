...
implement a \emph{universal circuit}~\cite{STOC:Valiant76}, which can
represent any conditional branch.
\iffull
We discuss universal circuits in more detail in Supplementary Material.
\else
We discuss universal circuits
\cite{EPRINT:LipMohSad16,EC:KisSch16,AC:GunKisSch17,AC:ZYZL19,JC:AGKS20,AC:KenKolWil17}
in more detail in the full version of this paper.
\fi
