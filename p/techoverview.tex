...
For concreteness and wlog,
%in our discussion we 
consider the illustrative example of an $8$-leaf tree in~\Cref{fig:seed-tree}, where $\guess=0$.  It will be clear that the discussion and arguments pertaining to this special case generalize to arbitrary $b$ and $\guess$.
...
This observation notices the costly recursive emulation.  Its elimination was the fist step towards our construction, whose technical detail is described above in~\Cref{sec:techOverview}.
