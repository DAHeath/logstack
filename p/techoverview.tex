...
By way of example, let's consider the special case of $\guess=0$ and $\truth = 010$ and refer to the illustration of~\Cref{fig:seed-tree} depicting the $b=8$ branches and the binary tree built on it.  It will be clear that it generalizes to any \guess.  \E starts on the root of the tree.  She made $\guess = 0$, while active branch is $C_2$.  Since \E guessed $0$, ... tbd
