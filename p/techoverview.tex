...
In the context of the example in~\Cref{fig:seed-tree}, \G  garbles branches  $\cir_0,...,\cir_7$ as follows.  \G chooses a random
...
Now let’s consider the number of calls needed to \Ev.  Recall that our
