...
constants are low (see \Cref{sec:eval} for evidence) of these low constants.
...
\begin{figure}
  ...
  \caption{%
    ...
    (\Cref{fig:evcond}) and
    \gbcond\ (\Cref{fig:gbcond}) respectively.
  }\label{fig:scheme}
\end{figure}
...
Note, our presentation is a formalization of discussion in
