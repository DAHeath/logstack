...
\Cref{sec:proof}. Due to lack of space, proofs of these properties are
in Supplementary Material.

In terms of our efficiency, our scheme satisfies the following
property:
...
We start by defining a procedure, \gbtree~(\Cref{fig:gbtree}),
...
tree over the $b$ branches (c.f. \Cref{fig:gbtree} for an
example).
%
...
\begin{minipage}{0.97\linewidth}
  \begin{align*}
    ...
    &~~\mat_{mux} \gets \gbmux(e_\aid, d, d_cond, \Lambda_{out})\\
