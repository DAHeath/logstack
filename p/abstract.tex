...
\smallskip
  ...
  That the primary cause of \HK's increased computation is the
...
garbling) and report on performance.
In terms of wall-clock time, our performance is comparable to \HK's
for fewer than $16$ branches; for larger branching factors, our
approach clearly outperforms \HK.
For example, given $256$ branches, our approach is $64\times$ faster.
